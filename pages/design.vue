<template>
    <div class="z-20">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <button type="button" class="inline-flex items-center gap-x-1.5 rounded-md bg-amber-50/5 px-3 py-2 text-md font-semibold text-amber-400 shadow-xs hover:bg-amber-100/8 cursor-pointer backdrop-blur-xs" @click="goBack">
        ...
        <div class="relative isolate overflow-hidden py-24 sm:py-32">
            <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                    <p class="mt-2 text-4xl font-semibold tracking-tight text-pretty text-white sm:text-5xl">Design</p>
                    <h2 class="text-base/8 font-semibold text-amber-500">logos, branding, apps, websites and more</h2>
                    <p class="mt-6 text-lg/8 text-gray-300"> I have designed some cool stuff.</p>
                </div>
...
onMounted(() => {
    document.documentElement.style.setProperty('--base-app-color','var(--color-amber-500)');
});
