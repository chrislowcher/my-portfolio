        ...
        <div class="relative isolate overflow-hidden py-24 sm:py-32">
            <div class="relative mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl pb-8 lg:mx-0 lg:max-w-xl">
                    ...
                    <p class="mt-6 text-lg/8 text-gray-300">Mythic Track is a stat tracking platform for the popular card game <i>Magic: the Gathering</i> that's used by thousands across the globe. </p>
                                ...
                                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                                    <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                                        ...
                                        <div class="mt-10 flex items-center gap-4">
                                            ...
                                            <a href="https://discord.com/invite/9p26q7eduk" class="transition duration-200 ease-in-out text-md/6 font-semibold text-gray-900 dark:text-white cursor-pointer">Join our Discord Community <span aria-hidden="true">→</span></a>
                                        </div>
                                    </div>
                                </div>
